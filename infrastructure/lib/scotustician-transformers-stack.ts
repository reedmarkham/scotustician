...
export class ScotusticianTransformersStack extends Stack {
  ...
  const processingQueue = new Queue(this, 'EmbeddingProcessingQueue', {
      ...
      deadLetterQueue: {
  queue: new Queue(this, 'EmbeddingProcessingDLQ', {
  ...
  const checkpointQueue = new Queue(this, 'EmbeddingCheckpointQueue', {
  ...
  const batchSecurityGroup = new SecurityGroup(this, 'BatchSecurityGroup', {
      vpc: props.vpc,
  ...
  const spotComputeEnvironment = new ManagedEc2EcsComputeEnvironment(this, 'SpotComputeEnvironment', {
      vpc: props.vpc,
      spot: true,
  ...
  const jobQueue = new JobQueue(this, 'EmbeddingJobQueue', {
      computeEnvironments: [
        {
  ...
  const image = new DockerImageAsset(this, 'TransformersImage', {
  ...
  let container: ContainerDefinition;
    ...
    if (useGpu) {
      ...
      taskDefinition = new Ec2TaskDefinition(this, 'TransformersGpuTaskDef', {
      ...
      container = taskDefinition.addContainer('TransformersGpuContainer', {
        ...
        cpu: taskCpu,
        gpuCount: 1,
        logging: LogDrivers.awsLogs({ streamPrefix: 'transformers' }),
        environment: {
      ...
      const fargateTask = new FargateTaskDefinition(this, 'TransformersCpuTaskDef', {
        cpu: taskCpu,
  ...
  new CfnOutput(this, useGpu ? 'TransformersGpuTaskDefinitionArn' : 'TransformersCpuTaskDefinitionArn', {
    ...
    const batchJobDefinition = new EcsJobDefinition(this, 'EmbeddingJobDefinition', {
      ...
      container: new EcsEc2ContainerDefinition(this, 'EmbeddingJobContainer', {
        ...
        logging: LogDrivers.awsLogs({ streamPrefix: 'batch-embedding' }),
      }),
    ...
    const errorFilter = new MetricFilter(this, 'ErrorMetricFilter', {
      logGroup,
    ...
    new Alarm(this, 'TransformerErrorAlarm', {
